...
namespace Checkers.ViewModels
{
    ...
    /// <summary>
    /// View Model для окна 
    /// <see cref="T:Checkers.Views.GameNetClientView" />.
    /// </summary>
    public class GameNetClientViewModel : BaseViewModel
    {
        /// <summary>
        /// Модель игры по сети.
        /// </summary>
        private readonly IGameNetClientModel _gameNetClientModel;


        public GameNetClientViewModel(IGameNetClientModel gameNetClientModel)
        {
            _gameNetClientModel = gameNetClientModel;
        ...
        {
            _gameNetClientModel.View.Close();
        } // ExitToMenu
        ...
        {
            _gameNetClientModel.StartNewGame();
        } // NewGame
