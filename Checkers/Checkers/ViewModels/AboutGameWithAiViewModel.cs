...
namespace Checkers.ViewModels
{
    /// <inheritdoc />
    /// <summary>
    /// View Model для окна "о программе" для одиночной игры. 
    /// <see cref="T:Checkers.Views.AboutGameWithAiView" />.
    /// </summary>
    public sealed class AboutGameWithAiViewModel : BaseViewModel
    {
        public AboutGameWithAiViewModel()
        {
            ...
            Description += " против компьютера.";
        } // AboutGameWithAiViewModel ctor
