...
namespace Checkers.Models.Network.DBML
{
    ...
    partial void DeleteClients(Clients instance);
		...
		public CheckersDBDataContext() : 
				base(global::Checkers.Properties.Settings.Default.CheckersDBConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<GameHistory> GameHistory
		{
			get
			{
			...
			set
			{
							...
							|| (this._GameResult.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.GameHistory.Remove(this);
					}
					this._GameResult.Entity = value;
					if ((value != null))
					{
						value.GameHistory.Add(this);
	...
	public partial class GameResult : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GameHistory> _GameHistory;
    ...
    partial void OnStateChanged();
		...
		public GameResult()
		{
			this._GameHistory = new EntitySet<GameHistory>(new Action<GameHistory>(this.attach_GameHistory), new Action<GameHistory>(this.detach_GameHistory));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="GameResult_GameHistory", Storage="_GameHistory", ThisKey="Id", OtherKey="IdResult")]
		public EntitySet<GameHistory> GameHistory
		{
			get
			{
			...
			set
			{
				this._GameHistory.Assign(value);
			}
		}
		...
		private void attach_GameHistory(GameHistory entity)
		{
			this.SendPropertyChanging();
			entity.GameResult = this;
		}
		
		private void detach_GameHistory(GameHistory entity)
		{
			this.SendPropertyChanging();
